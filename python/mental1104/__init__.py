...
#   Base: mental1104.connector.postgres  (others: mental1104.db.orm_base)
...
from mental1104.db.config import ConnParams, DBKind, SASettings, conn_params_from_env
...
from mental1104.db.orm_base import NAMING_CONVENTION
