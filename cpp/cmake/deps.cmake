...
function(m1104_collect_installable_submodules)
  ...
  foreach(_rel IN LISTS _lib_subs)
    ...
    if ((APPLE OR WIN32) AND _rel STREQUAL "lib/redis-plus-plus")
      message(STATUS "Skip redis-plus-plus install on this platform: ${_rel}")
      continue()
    endif()
...
macro(m1104_setup_testing_and_benchmark)
  ...
  if (WIN32)
    message(STATUS "WIN32 detected -> disable google benchmark (unsupported regex backend on MSVC)")
...
function(register_component NAME SUBPATH)
    ...
    if (EXISTS "${_root}/CMakeLists.txt")
        ...
        if (NOT ((APPLE OR WIN32) AND SUBPATH STREQUAL "lib/redis-plus-plus"))
...
foreach(_build_dir IN LISTS _m1104_submodule_builds)
  ...
  if((CMAKE_SYSTEM_NAME STREQUAL "Darwin" OR CMAKE_SYSTEM_NAME MATCHES "Windows")
     AND _build_dir MATCHES "/lib/redis-plus-plus/build$")
    message(STATUS "[submodule-install] skip ${_build_dir} on ${CMAKE_SYSTEM_NAME}")
    continue()
  endif()
  ...
  if(NOT _m1104_submod_res EQUAL 0)
    if(CMAKE_SYSTEM_NAME STREQUAL "Darwin" OR CMAKE_SYSTEM_NAME MATCHES "Windows")
      message(WARNING "[submodule-install] failed for ${_build_dir} (code=${_m1104_submod_res}); continue on ${CMAKE_SYSTEM_NAME}")
    else()
