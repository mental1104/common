...
- Dev CLI: build-export-cpp auto-passes pybind11_DIR from python/.venv if available. Python test/coverage prepend PYTHONPATH with export/cpp/build to expose mental1104_export_layer.
